...
//   // Sample data for each table with images
...
//       images: [], // No images for outstanding table
//     },
//     // ... more data
//   ];
...
//       requestDate: "10/05/2023",
//       qaPerson: "",
//       images: ["front-view.jpg", "side-view.jpg", "interior-1.jpg", "interior-2.jpg", "damage-spot.jpg"],
//       isRush: true,
//     },
//     {
//       id: 2,
...
//       qaPerson: "",
//       images: ["exterior.jpg", "roof.jpg", "basement.jpg"],
//       isRush: false,
//       isDuplicate: true,
//     },
//     // ... more data
...
//       id: 1,
//       name: "Randy Quaid",
//       email: "randy.quaid@example.com",
//       phone: "(555) 123-4567",
//       queueCount: 6,
//       finalReview: false,
//       images: ["review-1.jpg", "review-2.jpg", "review-3.jpg"],
//       isActive: true,
//     },
//     // ... more data
//   ];
...
//           <span className={TAB_HEADER}>Monitor Tasks</span>
...
//           {/* Tabs Section */}
//           <div className="p-0.5 rounded-lg flex items-center gap-1 w-full lg:w-fit overflow-x-auto scrollbar-hide">
//             {(["outstanding", "assignQA", "inReview", "finalReview", "completed"] as const).map((tab) => (
//               <button
//                 key={tab}
//                 onClick={() => setActiveTab(tab)}
//                 className={`px-4 py-3 rounded-lg flex justify-center items-center gap-2.5 transition-colors cursor-pointer ${
//                   activeTab === tab ? "bg-Rush" : ""
//                 }`}
//               >
//                 <div
...
//                   }`}
//                 >
//                   {tab === "assignQA" ? "Assign QA" :
//                    tab === "inReview" ? "In Review" :
//                    tab === "finalReview" ? "Final Review" :
